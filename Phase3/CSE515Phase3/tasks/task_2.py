...
def task2(first_image_folder, second_image_folder, feature_model, dimensionality_reduction, classifier='SVM',
          k=5):
    ...
    if database.check_if_latent_semantic_exist(X_train_id):
        ...
        Y_train = helper.get_image_labels(images_names, 2, "Training")
    else:
        ...
        Y_train = helper.get_image_labels(all_images, 2, "Training")
    ...
    Y_test = helper.get_image_labels(test_images, 2, "Testing")
...
if __name__ == '__main__':
    ...
    task2(training_folder_path, testing_folder_path, model_name, dimensionality_reduction, image_classifier, k)
    # task2('/Users/keenan/Desktop/ASU/Semester 1/Multimedia and Web Databases/Project/Phase3/CSE515Phase3/train',
