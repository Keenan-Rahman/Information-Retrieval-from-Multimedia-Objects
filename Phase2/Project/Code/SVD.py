...
def SVD(D, k):
    ...
    return [np.float32(U_k.real), np.float32(VT_k.real), projection, S_k] # return the projection, left factor matrix U, Core matrix S, and right factor matrix VT with respect to the k latent feature semantics
